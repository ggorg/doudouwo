...
import weixin.core.pojo.Button;
import weixin.core.pojo.CommonButton;
import weixin.core.pojo.ComplexButton;
import weixin.core.pojo.ViewButton;
import weixin.entity.Menu;
import weixin.entity.Pubweixin;
import weixin.services.MenuService;
import weixin.services.PubWeixinService;
import weixin.services.WeixinInterfaceService;
...
public class MenuController {
    ...
    public String list(@RequestParam(defaultValue = "1") Integer pageNo, String appid, Model model) {
        ...
        List<Menu> menuPage =  menuService.findListAll(appid);
    ...
    public ResponseVO release(String appid, HttpServletRequest request, Model model, RedirectAttributes redirectAttributes) {
        try {
            ...
            weixin.core.pojo.Menu m = new weixin.core.pojo.Menu ();
            //父级菜单
