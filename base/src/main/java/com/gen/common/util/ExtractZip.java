...
public class ExtractZip {
     ...
     * @throws Exception
     */
    public static List<String> unZip(InputStream in, String destDir) throws Exception {
        ...
        try {
            is = new ZipArchiveInputStream(new BufferedInputStream(in, BUFFER_SIZE));
    ...
    public static void main(String[] args) throws Exception {
        List<String> names = unZip("C:\\Users\\Administrator\\Desktop\\tianyi.zip", "C:\\Users\\Administrator\\Desktop\\zips");
